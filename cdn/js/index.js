  ...
  if (window.matchMedia("(max-width: 767px)").matches) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      button.addEventListener('click', function() {
        counter++;
        if (counter % 2 === 1) {
          desktop.style.backgroundImage = 'url(https://raw.githubusercontent.com/swattingzone-oss/doctorshield/refs/heads/main/imgs/mobile-girl.png)';
        } else {
          desktop.style.backgroundImage = 'url(https://raw.githubusercontent.com/swattingzone-oss/doctorshield/refs/heads/main/imgs/girl.jpg)';
        }
      });
    });
  }
